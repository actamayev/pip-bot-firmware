...
class MotorDriver {
  ...
  private:
    ...
    static constexpr uint32_t COMMAND_TIMEOUT_MS = 1000; // 1 second timeout
    ...
    uint32_t _left_brake_start_time = 0;
    uint32_t _right_brake_start_time = 0;
    static constexpr uint32_t BRAKE_RELEASE_TIME_MS = 1000; // 1 second brake hold time
