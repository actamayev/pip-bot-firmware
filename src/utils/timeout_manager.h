...
class TimeoutManager : public Singleton<TimeoutManager> {
    ...
    public:
        ...
        static constexpr unsigned long INACTIVITY_TIMEOUT = 10 * 1000; //9 * 60 * 1000; // 9 minutes
        static constexpr unsigned long CONFIRMATION_TIMEOUT = 10 * 1000;// 1 * 60 * 1000; // 1 minute
